...
#define BUTTON_SKIP_Pin GPIO_PIN_12
#define BUTTON_SKIP_GPIO_Port GPIOF
#define TEMP_DOWN_Pin GPIO_PIN_13
#define TEMP_DOWN_GPIO_Port GPIOF
#define TEMP_UP_Pin GPIO_PIN_9
#define TEMP_UP_GPIO_Port GPIOE
#define LD3_Pin GPIO_PIN_14
#define LD3_GPIO_Port GPIOB
#define BUTTON_VOL_DOWN_Pin GPIO_PIN_10
#define BUTTON_VOL_DOWN_GPIO_Port GPIOD
#define BUTTON_VOL_UP_Pin GPIO_PIN_11
#define BUTTON_VOL_UP_GPIO_Port GPIOD
#define BUTTON_PLAY_Pin GPIO_PIN_14
#define BUTTON_PLAY_GPIO_Port GPIOD
#define BUTTON_REWIND_Pin GPIO_PIN_15
#define BUTTON_REWIND_GPIO_Port GPIOD
