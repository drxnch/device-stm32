...
static struct mock_stm32l4xx_hal_gpioInstance
{
...
void mock_stm32l4xx_hal_gpio_Verify(void)
{
...
void mock_stm32l4xx_hal_gpio_Init(void)
{
  mock_stm32l4xx_hal_gpio_Destroy();
}

void mock_stm32l4xx_hal_gpio_Destroy(void)
{
...
void HAL_GPIO_Init(GPIO_TypeDef* GPIOx, GPIO_InitTypeDef* GPIO_Init)
{
  ...
  }
  {
    ...
    UNITY_TEST_ASSERT_EQUAL_MEMORY(cmock_call_instance->Expected_GPIO_Init, GPIO_Init, sizeof(GPIO_InitTypeDef), cmock_line, CMockStringMismatch);
  }
...
void HAL_GPIO_WritePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState)
{
  ...
  }
  {
    ...
    UNITY_TEST_ASSERT_EQUAL_MEMORY(&cmock_call_instance->Expected_PinState, &PinState, sizeof(GPIO_PinState), cmock_line, CMockStringMismatch);
  }
  if (cmock_call_instance->ReturnThruPtr_GPIOx_Used)
  {
    UNITY_TEST_ASSERT_NOT_NULL(GPIOx, cmock_line, CMockStringPtrIsNULL);
...
void CMockExpectParameters_HAL_GPIO_WritePin(CMOCK_HAL_GPIO_WritePin_CALL_INSTANCE* cmock_call_instance, GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState)
{
  ...
  cmock_call_instance->ReturnThruPtr_GPIOx_Used = 0;
  cmock_call_instance->Expected_GPIO_Pin = GPIO_Pin;
  memcpy((void*)(&cmock_call_instance->Expected_PinState), (const void*)(&PinState),
